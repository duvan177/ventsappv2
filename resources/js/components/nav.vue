    ...
    color: white; height: 70px;"
                ...
                <v-card-actions>
                    ...
                    <v-btn color="blue darken-1" text @click="limpiar()"
                        >Limpiar</v-btn
                    >
                    <v-btn color="blue darken-1" text @click="addingreso()"
                        >Agregar</v-btn
                    >
                </v-card-actions>
    ...
    methods: {
        ...
        addingreso() {
            ...
            if (
                ...
                let msg = [
                    "Complete los campos requeridos y que sean validos",
                    "red"
                ];
                this.notificacion(msg);
            }
        ...
        articulos() {
            axios
                ...
                .then(res => {
                      let newdata = res.data.filter(obj => obj.idcategoria != 5);
    ...
    watch: {
        ...
        articulo(val) {
            if (val) {
                ...
                if ((data[0].precio_venta_art, data[0].precio_compra)) {
                    this.p_venta = data[0].precio_venta_art;
                    this.p_compra = data[0].precio_compra.precio_compra;
                } else {
                    this.p_venta = null;
                    this.p_compra = null;
                     let msg = ["Este articulo no ha tenido ningun ingreso, defina PC Y PV", "warning"];
                this.notificacion(msg);
                }
